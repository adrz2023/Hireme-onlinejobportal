...
if(isset($_POST['submit'])){
  ...
  $query = "SELECT * FROM job_category WHERE category='$category' ";
  $result1 = mysqli_query($conn, $query);
  if(mysqli_num_rows($result1)>0){
    $error[] = 'category already exists !!';
  }
  else{
  $insert = "INSERT INTO job_category(category,des) VALUES('$category','$des') ";
         ...
         <div style="width: 60%; margin-left:25%; background-color:#F2F4F4;">
          ...
          ?>
                   <div class="from-group">
                    <lebel for=" customer email">Category name</lebel>
