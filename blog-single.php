...
if(!isset($_SESSION['IS_USER_LOGIN'])){
  ?>
  <script>
    window.location.href = "admin/new-post.php";
  </script>
  <?php
}
$id=$_GET['id'];
$job=null;
if(isset($id)){
  $query = mysqli_query($conn, "SELECT all_jobs.*,company.company from all_jobs,company WHERE company.customer_email=all_jobs.customer_email AND all_jobs.job_id ='$id'");
...
if (isset($_POST['submit'])) {
  ...
  $job_seeker = $_SESSION['USER_EMAIL']; 
  ...
  $sql="INSERT INTO `job_apply`( `first_name`, `last_name`, `dob`, `file`, `id_job`, `job_seeker`, `sex`, `address`) VALUES ('$first_name','$last_name','$dob','$filename','$id','$job_seeker','$gender','$address')";
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ftco-animate">
            <h2 class="mb-3"><?php echo $job['company'] ?></h2>
            <p><?php echo $job['district'] ?>,<?php echo $job['state'] ?>,<?php echo $job['country'] ?></p>
            <p><?php echo $job['des'] ?></p>
            
             <form action="blog-single.php?id=<?php echo $id; ?>" method="post" style="border: 1px solid gray" enctype="multipart/form-data">
             <div style=" padding: 2% ">
              <div class="row">
              <div class="col-sm-6">
              ...
              <div class="col-sm-6">
                ...
                <select type="text" class="form-control" name="gender" placeholder="enter sex type">
